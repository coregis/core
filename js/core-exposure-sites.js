...
window.onload=function(){
	getSpreadsheet('https://docs.google.com/spreadsheets/d/1kJQfD0X2-uAtpancD-ZhDnBAhUX-gNFcUPEVqhQKf3Y/pubhtml');
}
...
L.mapbox.accessToken = 'pk.eyJ1IjoiY29yZS1naXMiLCJhIjoiaUxqQS1zQSJ9.mDT5nb8l_dWIHzbnOTebcQ';
  ...
  // build map
  var map = L.mapbox.map('map').setView([16.299051,-101.865234],3);
  L.mapbox.styleLayer('mapbox://styles/core-gis/cjdesninp246u2rmuxxuect6u').addTo(map);
...
*/
  var overlayMaps = {
    "<img src='markers/radiation.svg' height=24>Radiation": radiation
  };
